...
$(document).ready(function () {
  ...
  // var counterNumber = document.querySelectorAll('.counter-numbers');
  // var additionOp = document.querySelectorAll('.additionOp');

  // for(var i = 0; i < additionOp.length; i++){
  //   var j = i
  //   $(additionOp[j]).on('click', function(e){
  //     e.preventDefault();
